...
(
    ...
    CONSTRAINT comics_authors_comics_id_fk FOREIGN KEY (comics_id) REFERENCES comics (id),
    CONSTRAINT comics_authors_authors_id_fk FOREIGN KEY (author_id) REFERENCES authors (id)  
);
